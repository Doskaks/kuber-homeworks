# Домашнее задание к занятию «Хранение в K8s», Марченко Николай
...
[containers-data-exchange.yaml](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP1/containers-data-exchange.yaml)

Скриншоты:

![1.1_data-exchange](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP1/1.1_data-exchange.jpg)

![1.2_data-exchange](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP1/1.2_data-exchange.jpg)

![1.3_data-exchange](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP1/1.3_data-exchange.jpg)

![2_tail-f.jpg](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP1/2_tail%20-f.jpg)
...
[pv-pvc.yaml](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP2/pv-pvc.yaml)

Скриншоты:

![2_создание PV и PVC](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP2/2_%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D0%B5%20PV%20%D0%B8%20PVC.jpg)

![3.1_логи busybox](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP2/3.1_%D0%BB%D0%BE%D0%B3%D0%B8%20busybox.jpg)

![3.2_логи multitool](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP2/3.2_%D0%BB%D0%BE%D0%B3%D0%B8%20multitool.jpg)

![3.3_файлы в контейнерах](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP2/3.3_%D1%84%D0%B0%D0%B9%D0%BB%D1%8B%20%D0%B2%20%D0%BA%D0%BE%D0%BD%D1%82%D0%B5%D0%B9%D0%BD%D0%B5%D1%80%D0%B0%D1%85.jpg)

![4_удаление Deployment и PVC](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP2/4_%D1%83%D0%B4%D0%B0%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5%20Deployment%20%D0%B8%20PVC.jpg)

![5.1_файл на ноде](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP2/5.1_%D1%84%D0%B0%D0%B9%D0%BB%20%D0%BD%D0%B0%20%D0%BD%D0%BE%D0%B4%D0%B5.jpg)

![5.2_удаление PV](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP2/5.2_%D1%83%D0%B4%D0%B0%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5%20PV.jpg)

![5.3_файл на ноде после удаления PV](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP2/5.3_%D1%84%D0%B0%D0%B9%D0%BB%20%D0%BD%D0%B0%20%D0%BD%D0%BE%D0%B4%D0%B5%20%D0%BF%D0%BE%D1%81%D0%BB%D0%B5%20%D1%83%D0%B4%D0%B0%D0%BB%D0%B5%D0%BD%D0%B8%D1%8F%20PV.jpg)
...
Причина:
    ...
    В манифесте PV установлена политика восстановления persistentVolumeReclaimPolicy: Retain

    При удалении PVC с такой политикой, PV не удаляется автоматически, PV переходит в статус Released, что означает, что его PVC больше не существует

    Данные на физическом диске сохраняются

    PV нельзя сразу использовать с новым PVC - требуется ручная очистка

    Это сделано для безопасности данных - администратор должен самостоятельно решить, удалять данные или нет.



После удаления PV, файл /mnt/data/data.txt остался на локальном диске ноды.

Причина:

    Local PV - это прямое отображение на файловую систему ноды

    Kubernetes управляет только абстрактными объектами (PV, PVC), но не физическими файлами на диске

    Удаление PV из Kubernetes удаляет только объект в API, но не затрагивает файловую систему

    Это особенность local типа хранилища - данные сохраняются на диске

    Для полной очистки требуется ручное удаление файлов администратором
...
[sc.yaml](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP3/sc.yaml)

Скриншоты:

![2_работающий pod](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP3/2_%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%B0%D1%8E%D1%89%D0%B8%D0%B9%20pod.jpg)

![3.1_логи записи данных](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP3/3.1_%D0%BB%D0%BE%D0%B3%D0%B8%20%D0%B7%D0%B0%D0%BF%D0%B8%D1%81%D0%B8%20%D0%B4%D0%B0%D0%BD%D0%BD%D1%8B%D1%85.jpg)

![3.2_логи чтения данных](https://github.com/Doskaks/kuber-homeworks/blob/main/2.1/LP3/3.2_%D0%BB%D0%BE%D0%B3%D0%B8%20%D1%87%D1%82%D0%B5%D0%BD%D0%B8%D1%8F%20%D0%B4%D0%B0%D0%BD%D0%BD%D1%8B%D1%85.jpg)
